<template>
  <ion-page>
    ...
    <ion-content class="content">
      <ion-item>
        <ion-input :value="name" ref="newTodoItem" @input="updateTodoName" placeholder="New Project Name"></ion-input>
      </ion-item>
...
export default {
  ...
  methods:{
    addTodo(){
      this.$router.push({path: '/project/projectDescription'})
      // const newTodo = {name: this.name}
      // axios.post('http//localhost:3001/todos' , newTodo)
      // .then(res => {
      //   console.log('I have been pressed and working')
